...
type MenuItem = { id: string; name: string; description: string | null; price: number; category: string | null; category_id: string | null; is_featured: boolean }
...
export default function DinerOrderPage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      supabase.rpc('public_restaurant_order_status', { p_table_token: data.table.token, p_order_id: localOrder.id }).then(({ data: tracked }) => {
